...
The driver-species relationships remain fairly consistent regadless of which species interactions are included. A couple of changes in the significance but the point estimates are much more important than the P-values.

Lake level is using positive values, the lake level _Tsuga_ effect is wetter conditions favouring _Tsuga_.
...
I'm not seeing a great deal of very strong interactions, this is the more challenging part for the model to estimate. Looks like there is a negative effect of _Tsuga_ on _Betula_.
